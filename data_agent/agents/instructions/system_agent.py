...
Rules:
1. CRITICAL: Base the title only on given message.
2. The title is a concise noun phrase (2–8 words) describing the topic or intent of that message. 
   It is not a full sentence and not an answer to the message.
3. Write the title in the same language as the message. Do not translate it.
